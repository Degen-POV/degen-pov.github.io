  ...
  return (
    ...
    >
      <div className="flex items-center w-[95%]">
        <div className="flex flex-col items-center relative flex-grow" style={{ height: `${containerSize.height}px`, backgroundColor: '#26437d' }}>
          <div className="w-full h-full overflow-hidden flex items-center justify-center pdf-loading-text"
        ...
        <div className="flex flex-col items-center justify-center ml-4 h-full">
          <button
